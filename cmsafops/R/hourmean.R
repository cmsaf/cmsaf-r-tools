...
#'
#'The function determines hourly means from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of hourly means is written.
#'@export
#'
...
#'  }
hourmean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                     verbose = FALSE, nc = NULL) {
  hourx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}