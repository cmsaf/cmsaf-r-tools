...
#'
#'This function divides each timestep of a time series by the number of days of
#'the corresponding month. This can be useful to convert units, such as
#'millimeters (mm) to monthly millimeters per day (mm/d). Leap-years are
#'included.
#'
...
divdpm <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE,
                   verbose = FALSE, nc = NULL) {
  xdpm_wrapper("div", var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
