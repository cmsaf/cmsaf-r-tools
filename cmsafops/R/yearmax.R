...
#'
#'The function determines annual maxima from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of annual maxima is written.
#'@export
#'
...
yearmax <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                    verbose = FALSE) {
  yearx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose)
}
