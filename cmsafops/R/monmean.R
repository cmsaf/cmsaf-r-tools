...
#'
#'@return A NetCDF file including a time series of monthly means is written.
#'@export
#'
...
monmean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  monx_wrapper(3, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
