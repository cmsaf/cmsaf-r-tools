...
#'
#'The function determines multi-year monthly sums from data of a single CM SAF
#'NetCDF input file.
#'
...
#'
#'@return A NetCDF file including a time series of multi-year monthly sums is
#'  written.
#'@export
#'
...
ymonsum <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  ymonx_wrapper(4, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
