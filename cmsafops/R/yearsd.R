...
#'
#'The function determines annual standard deviation from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of annual standard deviation is written.
#'@export
#'
...
yearsd <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                   verbose = FALSE, nc = NULL) {
  yearx_wrapper(3, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
