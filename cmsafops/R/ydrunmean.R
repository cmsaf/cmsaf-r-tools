...
#'
#'The function determines multi-year daily running mean values from data of a 
...
#'
#'@return A NetCDF file including a time series of multi-year daily running means 
#'  is written.
#'@export
#'
...
ydrunmean <- function(var, nts = 6, infile, outfile, nc34 = 4, overwrite = FALSE, 
                      verbose = FALSE, nc = NULL) {
  ydrunx_wrapper(2, var, infile, outfile, nc34, overwrite, nts = nts, verbose = verbose, nc = nc)
}
