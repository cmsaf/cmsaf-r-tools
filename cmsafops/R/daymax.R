...
#'
#'The function determines daily maximum from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of daily maximum is written.
#'@export
#'
...
daymax <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                   verbose = FALSE, nc = NULL) {
  dayx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose = verbose, nc = nc)
}