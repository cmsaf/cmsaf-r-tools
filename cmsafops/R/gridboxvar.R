...
#'
#'The function determines variances of selected grid boxes from data of a single 
...
#'
#'@return A NetCDF file including a time series of variances of selected grid boxes is written.
#'@export
#'
...
#'  "CMSAF_example_file_gridboxvar.nc")))
gridboxvar <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  gridboxx_wrapper(7, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose)
}
