...
#'  "CMSAF_example_file_gridboxmean.nc")))
gridboxmean <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  gridboxx_wrapper(5, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose)
}
