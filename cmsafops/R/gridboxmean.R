...
#'
#'The function determines means of selected grid boxes from data of a single 
...
#'
#'@return A NetCDF file including a time series of means of selected grid boxes is written.
#'@export
#'
...
#'  "CMSAF_example_file_gridboxmean.nc")))
gridboxmean <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  gridboxx_wrapper(5, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
