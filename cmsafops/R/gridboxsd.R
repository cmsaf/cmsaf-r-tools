...
#'
#'The function determines standard deviations of selected grid boxes from data 
#'of a single CM SAF NetCDF input file.
#'
...
#'
#'@return A NetCDF file including a time series of standard deviations of selected grid boxes is written.
#'@export
#'
...
#'  "CMSAF_example_file_gridboxsd.nc")))
gridboxsd <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  gridboxx_wrapper(6, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
