...
#'  "CMSAF_example_file_gridboxsd.nc")))
gridboxsd <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  gridboxx_wrapper(6, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose)
}
