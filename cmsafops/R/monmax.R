...
#'
#'The function determines monthly maximum values from data of a single CM SAF
...
monmax <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  monx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
