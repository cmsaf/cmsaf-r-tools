...
runmean <- function(var, nts = 6, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  runx_wrapper(5, var, infile, outfile, nc34, overwrite, nts = nts, verbose = verbose, nc = nc)
}
