...
#'
#'The function determines monthly sums from data of a single CM SAF NetCDF input
#'file. This function is applicable to 3-dimensional NetCDF data.
#'
...
#'
#'@return A NetCDF file including a time series of monthly sums is written.
#'@export
#'
...
monsum <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  monx_wrapper(4, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
