...
#'
#'The function determines multi-year seasonal maximum values from data of a
...
#'
#'@return A NetCDF file including a time series of multi-year seasonal maxima is
#'  written.
#'@export
#'
...
yseasmax <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  yseasx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
