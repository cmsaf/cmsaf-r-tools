...
#'
#'The function divides the fields of infile1 by the fields of infile2. Infiles have
...
cmsaf.div <- function(var1, var2, infile1, infile2, outfile, nc34=4,
  ...
  arith_wrapper(4, var1, var2, infile1, infile2, outfile, nc34, overwrite, verbose, nc1 = nc1, nc2 = nc2)
}
