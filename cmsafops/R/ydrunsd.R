...
#'
#'@return A NetCDF file including a time series of multi-year daily running 
...
ydrunsd <- function(var, nts = 6, infile, outfile, nc34 = 4, overwrite = FALSE, 
                    verbose = FALSE, nc = NULL) {
  ydrunx_wrapper(3, var, infile, outfile, nc34, overwrite, nts = nts, verbose = verbose, nc = nc)
}
