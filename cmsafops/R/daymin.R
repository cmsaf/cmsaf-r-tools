...
#'
#'The function determines the daily minimum from data of a single CM SAF NetCDF 
#'input file.
#'
...
#'
#'@return A NetCDF file including a time series of daily minimum is written.
#'@export
#'
...
daymin <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                   verbose = FALSE, nc = NULL) {
  dayx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose = verbose, nc = nc)
}