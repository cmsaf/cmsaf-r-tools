...
#'
#'The function determines multi-year daily minimum from data of a single 
...
#'
#'@return A NetCDF file including a time series of multi-year daily minimum is written.
#'@export
#'
...
ydaymin <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                    verbose = FALSE, nc = NULL) {
  ydayx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}