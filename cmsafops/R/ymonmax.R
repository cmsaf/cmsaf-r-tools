...
#'
#'The function determines multi-year monthly maximum values from data of a
...
#'
#'@return A NetCDF file including a time series of multi-year monthly maxima is
#'  written.
#'@export
#'
...
ymonmax <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  ymonx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
