...
#'
#'The function determines the mean value of each timestep from data of a single
#'NetCDF file. The input file should contain a time series of 2D-data.
#'
...
#'
#'@return A NetCDF file including a time series of spatial means is written.
#'@export
#'
...
fldmean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE,
                    verbose = FALSE, nc = NULL) {
  fldx_wrapper(3, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
