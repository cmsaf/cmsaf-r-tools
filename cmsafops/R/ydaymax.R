...
#'
#'The function determines multi-year daily maximum from data of a single 
...
#'
#'@return A NetCDF file including a time series of multi-year daily maximum is written.
#'@export
#'
...
ydaymax <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                    verbose = FALSE, nc = NULL) {
  ydayx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}