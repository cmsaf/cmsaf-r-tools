...
#'
#'The function determines zonal sums from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of zonal sums is written.
#'@export
#'
...
zonsum <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                   verbose = FALSE, nc = NULL) {
  zonx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
