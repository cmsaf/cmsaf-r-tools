...
#'
#'The function determines maxima of selected grid boxes from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of maxima of selected grid boxes is written.
#'@export
#'
...
gridboxmax <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  gridboxx_wrapper(1, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
