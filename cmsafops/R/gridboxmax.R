...
gridboxmax <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  gridboxx_wrapper(1, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose)
}
