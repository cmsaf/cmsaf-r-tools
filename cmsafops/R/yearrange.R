...
#'
#'The function calculates the difference of maximum and minimum values by yearly 
...
#'
#'@return A NetCDF file including a time series of annual range is written.
#'@export
#'
...
yearrange <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                      verbose = FALSE, nc = NULL) {
  yearx_wrapper(5, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
