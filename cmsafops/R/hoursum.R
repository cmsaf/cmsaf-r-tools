...
#'
#'The function determines hourly sums from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of hourly sums is written.
#'@export
#'
...
hoursum <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                    verbose = FALSE) {
  hourx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose)
}