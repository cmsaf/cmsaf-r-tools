...
#'
#'The function determines multi-year monthly median values from data of a single
...
#'
#'@return A NetCDF file including a time series of multi-year monthly medians is
#'  written.
#'@export
#'
...
ymonmedian <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  ymonx_wrapper(6, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
