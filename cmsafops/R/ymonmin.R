...
#'
#'The function determines multi-year monthly minimum values from data of a
...
#'
#'@return A NetCDF file including a time series of multi-year monthly minima is
#'  written.
#'@export
#'
...
ymonmin <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  ymonx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
