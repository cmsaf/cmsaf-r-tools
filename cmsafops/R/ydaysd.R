...
#'
#'The function determines multi-year daily standard deviations from data of a 
...
#'
#'@return A NetCDF file including a time series of multi-year daily standard 
...
ydaysd <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                   verbose = FALSE, nc = NULL) {
  ydayx_wrapper(4, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}