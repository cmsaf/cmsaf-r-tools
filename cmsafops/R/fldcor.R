...
fldcor <- function(var1, infile1, var2, infile2, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  fld_cor_covar_wrapper("fldcor", var1, infile1, var2, infile2, outfile, nc34, overwrite, verbose)
}