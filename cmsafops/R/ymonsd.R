...
#'
#'The function determines multi-year monthly standard deviation values from data
...
#'
#'@return A NetCDF file including a time series of multi-year monthly standard
...
ymonsd <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  ymonx_wrapper(5, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
