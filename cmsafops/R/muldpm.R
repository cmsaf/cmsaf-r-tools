...
#'
#'This function multiplies each timestep of a time series by the number of days
#'of the corresponding month. This can be useful to convert units, such as
#'monthly millimeters per day (mm/d) to millimeters (mm). Leap-years are
#'included.
#'
...
#'
#'@return A NetCDF file including a time series of the length of infile is
#'  written.
#'@export
#'
...
muldpm <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  xdpm_wrapper("mul", var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
