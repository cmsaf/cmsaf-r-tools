...
#'
#'The function determines running minima from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of running minima is written.
#'@export
#'
...
runmin <- function(var, nts = 6, infile, outfile, nc34 = 4, overwrite = FALSE, 
                   verbose = FALSE, nc = NULL) {
  runx_wrapper(1, var, infile, outfile, nc34, overwrite, nts = nts, verbose = verbose, nc = nc)
}
