...
#'  "CMSAF_example_file_gridboxrange.nc")))
gridboxrange <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  gridboxx_wrapper(3, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose)
}
