...
#'
#'The function determines ranges of selected grid boxes from data of a single 
...
#'
#'@return A NetCDF file including a time series of ranges of selected grid boxes is written.
#'@export
#'
...
#'  "CMSAF_example_file_gridboxrange.nc")))
gridboxrange <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  gridboxx_wrapper(3, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
