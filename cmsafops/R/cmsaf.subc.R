...
#'
#'This function subtracts a given constant number from each element of a
#'dataset.
#'
#'@aliases subc
#'
...
cmsaf.subc <- function(var, const = 0, infile, outfile, nc34 = 4,
                       overwrite = FALSE, verbose = FALSE, nc = NULL) {
  arithc_wrapper(2, var, const, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
