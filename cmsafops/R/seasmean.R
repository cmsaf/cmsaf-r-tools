...
#'
#'The function determines seasonal mean values from data of a single CM SAF
#'NetCDF input file. The seasonal mean is only determined if all three months of
...
#'
#'@return A NetCDF file including a time series of seasonal means is written.
#'@export
#'
...
seasmean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  seasx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
