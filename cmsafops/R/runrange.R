...
#'
#'The function calculates the running difference of maximum and minimum values 
...
#'
#'@return A NetCDF file including a time series of running range is written.
#'@export
#'
...
runrange <- function(var, nts = 6, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  runx_wrapper(3, var, infile, outfile, nc34, overwrite, nts = nts, verbose = verbose, nc = nc)
}
