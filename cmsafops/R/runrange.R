...
runrange <- function(var, nts = 6, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  runx_wrapper(3, var, infile, outfile, nc34, overwrite, nts = nts, verbose = verbose)
}
