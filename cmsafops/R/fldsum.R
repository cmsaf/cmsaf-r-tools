...
#'
#'The function determines the sum of each timestep from data of a
...
#'
#'@return A NetCDF file including a time series of sum is written.
#'@export
#'
...
fldsum <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE,
                   verbose = FALSE, nc = NULL) {
  fldx_wrapper(7, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
