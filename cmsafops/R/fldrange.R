...
#'
#'The function determines the difference of maximum and minimum values of each timestep 
#'from data of a single NetCDF file. The input file should contain a time series 
#'of 2D-data.
#'
...
#'
#'@return A NetCDF file including a time series of range is written.
#'@export
#'
...
fldrange <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE,
                   verbose = FALSE, nc = NULL) {
  fldx_wrapper(5, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
