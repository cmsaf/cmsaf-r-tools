...
#'  "CMSAF_example_file_gridboxsum.nc")))
gridboxsum <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  gridboxx_wrapper(4, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose)
}
