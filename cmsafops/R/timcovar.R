...
timcovar <- function(var1, infile1, var2, infile2, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  tim_cor_covar_wrapper("timcovar", var1, infile1, var2, infile2, outfile, nc34, overwrite, verbose)
}