...
#'
#'The function determines monthly standard deviation values from data of a
...
monsd <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  monx_wrapper(5, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
