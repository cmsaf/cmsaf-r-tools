...
#'
#'The function determines meridional means from data of a single CM SAF NetCDF 
#'input file.
#'
...
#'
#'@return A NetCDF file including a time series of meridional means is written.
#'@export
#'
#'@family meridional statistics
#'
#' @examples
...
mermean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                    verbose = FALSE, nc = NULL) {
  merx_wrapper(1, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
