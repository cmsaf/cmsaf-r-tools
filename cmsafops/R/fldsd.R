...
#'
#'The function determines the standard deviation of each timestep from data of a
#'single NetCDF file. The input file should contain a time series of 2D-data.
#'
...
#'
#'@return A NetCDF file including a time series of spatial standard deviation is written.
#'@export
#'
...
fldsd <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE,
                   verbose = FALSE, nc = NULL) {
  fldx_wrapper(6, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
