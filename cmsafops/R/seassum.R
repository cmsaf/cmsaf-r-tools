...
#'
#'The function determines seasonal sum values from data of a single CM SAF
#'NetCDF input file. The seasonal sum is only determined if all three months of
...
#'
#'@return A NetCDF file including a time series of seasonal sums is written.
#'@export
#'
...
seassum <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  seasx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
