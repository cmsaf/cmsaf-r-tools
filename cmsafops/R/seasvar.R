...
#'
#'The function determines seasonal variances values from data of a single CM SAF
#'NetCDF input file. The seasonal variances is only determined if all three months of
...
#'
#'@return A NetCDF file including a time series of seasonal variances is written.
#'@export
#'
...
seasvar <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                    verbose = FALSE, nc = NULL) {
  seasx_wrapper(4, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
