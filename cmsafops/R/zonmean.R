...
#'
#'The function determines zonal means from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of zonal means is written.
#'@export
#'
#'@family zonal statistics
#'
#' @examples
...
zonmean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                    verbose = FALSE, nc = NULL) {
  zonx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
