...
#'  written. Standard output precision is 'integer'.
#'@export
#'
...
num_below <- function(var, thld = 0, infile, outfile, nc34 = 4,
                       overwrite = FALSE, verbose = FALSE, nc = NULL) {
  num_wrapper(2, var, thld, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
