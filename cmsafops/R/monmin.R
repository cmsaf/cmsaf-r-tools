...
#'
#'The function determines monthly minimum values from data of a single CM SAF
...
monmin <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  monx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
