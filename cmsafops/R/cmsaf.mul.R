...
#'
#'The function multiplies the fields of infile1 and infile2. Infiles have to
...
#'  object of class `ncdf4` (as returned from \code{ncdf4::nc_open}).
#'
#'@return A NetCDF file including the multiplied fields of infile1 and infile2
#'  is written.
#'@export
#'
...
cmsaf.mul <- function(var1, var2, infile1, infile2, outfile, nc34=4,
  ...
  arith_wrapper(3, var1, var2, infile1, infile2, outfile, nc34, overwrite, verbose, nc1 = nc1, nc2 = nc2)
}
