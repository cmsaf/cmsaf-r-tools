...
#'
#'The function determines multi-year seasonal minimum values from data of a
...
yseasmin <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
