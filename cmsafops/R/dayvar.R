...
#'
#'The function determines daily variances from data of a single CM SAF NetCDF 
#'input file.
#'
...
#'
#'@return A NetCDF file including a time series of daily variances is written.
#'@export
#'
...
dayvar <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                   verbose = FALSE, nc = NULL) {
  dayx_wrapper(6, var, infile, outfile, nc34, overwrite, verbose = verbose, nc = nc)
}