...
#'
#'The function determines monthly variance values from data of a
...
monvar <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  monx_wrapper(6, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
