...
#'
#'The function determines daily standard deviations from data of a single CM SAF 
#'NetCDF input file.
#'
...
#'
#'@return A NetCDF file including a time series of daily standard deviations is written.
#'@export
#'
...
daysd <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, 
                  verbose = FALSE, nc = NULL) {
  dayx_wrapper(5, var, infile, outfile, nc34, overwrite, verbose = verbose, nc = nc)
}