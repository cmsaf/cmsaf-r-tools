...
#'
#'The function determines all-time maximum values from data of a single CM SAF
...
#'
#'@return A NetCDF file including a time series of all-time maxima is written.
#'@export
#'
...
timmax <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  timx_wrapper("max", var, infile, outfile, nc34, overwrite, verbose = verbose, nc = nc)
}
