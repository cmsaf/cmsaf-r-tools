...
#'
#'The function determines annual variance from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of annual variance is written.
#'@export
#'
...
yearvar <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  yearx_wrapper(4, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
