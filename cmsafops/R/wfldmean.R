...
#'
#'The function determines area weighted mean values from data of a single file.
#'The calculation is based on the 'weighted.mean' function of the
#'\link[raster:raster-package]{raster package}.
#'
