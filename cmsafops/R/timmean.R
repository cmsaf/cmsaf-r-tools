...
#'
#'The function determines the all-time mean from data of a single CM SAF NetCDF
#'input file and is useful to calculate climatological means. The function
#'limits the timesteps, which are read at once, to avoid RAM overflow.
#'
...
#'
#'@return A NetCDF file including the temporal mean is written.
#'@export
#'
...
timmean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  timx_wrapper("mean", var, infile, outfile, nc34, overwrite, verbose = verbose)
}
