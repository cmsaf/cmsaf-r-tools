...
#'  "CMSAF_example_file_gridboxmin.nc")))
gridboxmin <- function(var, lonGrid, latGrid, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  gridboxx_wrapper(2, var, lonGrid, latGrid, infile, outfile, nc34, overwrite, verbose)
}
