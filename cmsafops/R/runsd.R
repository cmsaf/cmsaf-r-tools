...
#'
#'The function determines running standard deviation from data of a single 
...
#'
#'@return A NetCDF file including a time series of running standard deviation is written.
#'@export
#'
...
runsd <- function(var, nts = 6, infile, outfile, nc34 = 4, overwrite = FALSE, 
                  verbose = FALSE, nc = NULL) {
  runx_wrapper(6, var, infile, outfile, nc34, overwrite, nts = nts, verbose = verbose, nc = nc)
}
