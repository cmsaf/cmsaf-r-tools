...
#'
#'The function determines the minimum value of each timestep from data of a
...
#'
#'@return A NetCDF file including a time series of minimum values is written.
#'@export
#'
...
fldmin <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE,
                   verbose = FALSE, nc = NULL) {
  fldx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
