...
#'
#'The function determines covariances in grid space from data of two CM SAF
...
#'  object of class `ncdf4` (as returned from \code{ncdf4::nc_open}).
#'
#'@return A NetCDF file including a time series of covariances in grid space is written.
#'@export
#'
...
fldcovar <- function(var1, infile1, var2, infile2, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc1 = NULL, nc2 = NULL) {
  fld_cor_covar_wrapper("fldcovar", var1, infile1, var2, infile2, outfile, nc34, overwrite, verbose, nc1 = nc1, nc2 = nc2)
}