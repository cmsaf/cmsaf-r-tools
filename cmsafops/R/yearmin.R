...
#'
#'The function determines annual minima from data of a single CM SAF NetCDF input
#'file.
#'
...
#'
#'@return A NetCDF file including a time series of annual minima is written.
#'@export
#'
...
yearmin <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  yearx_wrapper(2, var, infile, outfile, nc34, overwrite, verbose, nc = nc)
}
