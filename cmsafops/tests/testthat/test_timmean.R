...
test_that("attributes are correct", {
  ...
  expect_equal(actual, "cmsaf::timmean for variable SIS")
...
test_that("data is correct", {
  ...
  temp1 <- seq(250, 272)
  expected_data <- c(rep(c(253:272, 261.5:263.5), 2), temp1[4:6]) - 1.5
  expected <- array(expected_data, dim = c(7, 7))
...
test_that("data is correct", {
  ...
  temp1 <- seq(250, 272)
  expected_data <- c(rep(c(254.5:267.5, 262.75:264.75, 260:262, 257.25:259.25), 2), 254.5:256.5)
  expected <- array(expected_data, dim = c(7, 7))
