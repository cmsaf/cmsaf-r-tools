...
test_that("data is correct", {
  ...
  expected_data <- c(
    1.9401544,1.9401544,1.9401544,
    1.3227799,1.3227799,1.9401544,
    1.9401544,1.9401544,1.3227799,
    1.3227799,1.9401544,1.9401544,
    1.9401544,1.3227799,1.3227799
  )
  expected <- array(expected_data, c(5,3))
...
test_that("attributes are correct", {
  ...
  expect_equal(actual, "cmsafops::cmsaf.regres for variable SIS")
...
#   #expect_equal(actual, array(c(166560)))
# })
# 
# nc_close(file)
# 
