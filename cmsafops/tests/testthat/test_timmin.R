...
test_that("attributes are correct", {
  ...
  expect_equal(actual, "cmsafops::timmin for variable SIS")
...
file_in <- file.path(data_dir, "ex_normal1.nc")
file_out <- tempfile_nc()
timmin("SIS", file_in, file_out, nc34 = 4)
file <- nc_open(file_out)
...
test_that("error is thrown if ncdf version is wrong", {
  expect_error(
    timmin("SIS", file_in, file_out, nc34 = 7),
...
test_that("ncdf version NULL throws an error", {
  expect_error(
    timmin("SIS", file_in, file_out, nc34 = NULL),
...
test_that("no error is thrown if overwrite = TRUE", {
  expect_error(
    timmin("SIS", file_in, file_out, overwrite = TRUE),
    NA
  )
})
...
test_that("data is correct", {
  ...
  temp1 <- seq(250, 272)
  expected_data <- c(rep(c(250:269, 250:252), 2), temp1[1:3])
  expected <- array(expected_data, dim = c(7, 7))
...
test_that("data is correct", {
  ...
  temp1 <- seq(250, 272)
  expected_data <- c(rep(c(250:263, rep(c(250:252), 3)), 2), temp1[1:3])
  expected <- array(expected_data, dim = c(7, 7))
...
test_that("data is correct", {
  ...
  temp1 <- seq(250, 269)
  expected_data <- c(rep(c(temp1, 250:252), 2), temp1[1:3])
  expected <- array(expected_data, dim = c(7, 7))
