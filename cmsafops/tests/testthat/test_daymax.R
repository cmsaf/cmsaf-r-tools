...
tempfile_nc <- function() {
  tempfile_helper("daymax_")
}

########## output ncdf version 3 ##########
file_out <- tempfile_nc()
daymax("SIS", file.path(data_dir, "ex_dayx.nc"), file_out)
file <- nc_open(file_out)

test_that("data is correct", {
  actual <- ncvar_get(file)
  
  expected_data <- c(271,272,270,271,272,270,271,
                     272,270,271,272,271,272,272,
                     271,272,272,271,272,272,271,
                     272,272,271,272,270,271,272,
                     270,271,272,270,271,272,271,
                     272,272,271,272,272,271,272,
                     272,271,272,272,271,272,270,
                     ...
                     272,271,272,272,271,272,272,
                     271,272,270,271,272,270,271,
                     272,271,272,272,271,272,272,
                     271,272,272,271,272,272,271,
                     272,272,271,272,270,271,272,
                     270,271,272,271,272,272,271,
                     272,272,271,272,272,271,272)
...
test_that("attributes are correct", {
  ...
  expect_equal(actual, "cmsafops::daymax for variable SIS")
...
file_out <- tempfile_nc()
daymax("SIS", file.path(data_dir, "ex_dayx.nc"), file_out, nc34 = 4)
file <- nc_open(file_out)
...
test_that("error is thrown if ncdf version is wrong", {
  expect_error(
    daymax("SIS", file.path(data_dir, "ex_dayx.nc"), file_out, nc34 = 7),
...
test_that("warning is shown if var does not exist", {
  expect_warning(daymax("notExist",
                        file.path(data_dir, "ex_dayx.nc"),
                        file_out),
