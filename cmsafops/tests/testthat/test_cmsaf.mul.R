...
test_that("data is correct", {
  ...
  expected_data <- rep(c(57500, 57981, 58464, 58949, 59436, 59925, 60416, 60909,
                         61404, 61901, 62400, 62901, 63404, 63909, 64416, 64925, 65436, 65949, 66464,
                         66981, 67500, 68021, 68544), 3)
...
test_that("attributes are correct", {
  ...
  expect_equal(actual, "cmsaf::cmsaf.mul for variable SIS")
...
test_that("error is thrown if ncdf version is wrong", {
  expect_error(
    cmsaf.mul("SIS", "SIS",
              file.path(data_dir, "ex_normal1.nc"),
              file.path(data_dir, "ex_normal2.nc"), file_out, nc34 = 7),
...
test_that("data is correct", {
  ...
  expected_data <- c(rep(c(57500, 57981, 58464, 58949, 59436, 59925, 60416, 60909,
                           61404, 61901, 62400, 62901, 63404, 63909, 64416, 64925, 65436, 65949, 66464,
                           66981, 67500, 68021, 68544), 2),
                     57500, 57981, 58464,
                     rep(c(58250, 58734, 59220, 59708, 60198, 60690, 61184, 61680, 62178, 62678,
                           63180, 63684, 64190, 64698, 65208, 65720, 66234, 66750, 67268, 67788,
                           62100, 62601, 63104), 2),
                     c(58250, 58734, 59220))
  expected <- array(expected_data, dim = c(7, 7, 2))
...
test_that("data is correct", {
  ...
  expected_data <- c(rep(c(57500, 57981, 58464, 58949, 59436, 59925, 60416, 60909,
                     ...
                     57500, 57981, 58464,
                     rep(c(58190, 58674,
                           59160, 59648, 60138, 60630, 61124, 61620, 62118, 62618, 63120, 63624, 64130,
                           64638, 65148, 65660, 66174, 66690, 67208, 67728, 62500, 63001, 63504), 2),
                     c(58190, 58674, 59160))
  expected <- array(expected_data, dim = c(7, 7, 2))
...
test_that("error is thrown if dimensions do not match", {
  expect_error(cmsaf.mul("SIS", "SIS",
